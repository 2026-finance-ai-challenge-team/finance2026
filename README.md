...
FORM:E는 먼저 **공공 마이데이터로 제출할 수 있는 증빙은 공식 경로로 안내**하고, 그 밖의 사문서·사진·원본은 한꺼번에 올려 목적·은행별 요건과 대조한 뒤 **디지털 제출·일괄인쇄·영업점 방문에 맞는 준비 완료 키트**로 만드는 AI 금융업무 준비 웹서비스입니다.
...
- FORM:E는 금융기관의 심사나 승인 여부를 보장하지 않습니다.
...
<sub>FORM:E · 2026 금융 AI Challenge</sub>
